          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Get started with Prone', style: TextStyle(fontSize: 14, color: textDimColor)),
                const SizedBox(height: 48),
                _CustomTextField(hint: 'Full Name', icon: 'assets/icons/profile.svg'),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('Already have an account? ', style: TextStyle(fontSize: 13, color: textDimColor)),
                    GestureDetector(
                      onTap: () => context.go('/login'),
                      child: const Text('Sign In', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.primary)),
                    ),
                  ],
                ),
              ],
